...
?>
<nav class="navbar navbar-expand-lg" style="background: #0e223e; min-height: 70px;">
  <div class="container-fluid">
    <a class="navbar-brand text-light" href="#">WM INVENTORY COMPANY OR BUSINNESS</a>
    ...
    <div class="d-flex flex-row-reverse bd-highlight" id="navbarSupportedContent">
      <div class="btn-group dropstart">
        ...
        <img src="<?= isset($profile['Profile_photo']) ? $profile['Profile_photo'] : '' ?>" class="rounded-circle" width="30px" height="30px">    
      </button>    
        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown">
          <li>
            <a class="dropdown-item" href="#"><i class="bi bi-person-bounding-bo"></i> <?= isset($profile['Profile_name']) ? $profile['Profile_name'] : '' ?></a>
          </li>
          <li>
