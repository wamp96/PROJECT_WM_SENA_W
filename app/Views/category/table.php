                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        <button type="button" title="Button Show Category"
                                            onclick="show(<?php echo $obj['Category_id']; ?>)" class="btn btn-success btn-action"
                                            style="font-size: 0.5em;"><i class="bi bi-eye-fill"></i></button>
                                        <button type="button" title="Button Edit Category"
                                            onclick="edit(<?php echo $obj['Category_id']; ?>)" class="btn btn-warning btn-action"
                                            style="font-size: 0.5em;"><i class="bi bi-pencil-square"
                                                style="color:white"></i></button>
                                        <button type="button" title="Button Delete Category"
                                            onclick="delete_(<?php echo $obj['Category_id']; ?>)" class="btn btn-danger btn-action"
