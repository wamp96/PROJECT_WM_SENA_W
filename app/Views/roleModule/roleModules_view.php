...
<body>
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content bg-dark text-white">
        ...
        <div class="modal-body">
          <!--Form-->
          <?php require_once('../app/Views/roleModule/form.php') ?>
          <!--End Form-->
        </div>
  ...
  <!--End Modal-->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content bg-dark text-white">
        <div class="modal-header">
          <h5 class="modal-title" id="my-modalLabel"><?= $titlePermissions ?></h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <!--Form-->
          <?php require_once('../app/Views/roleModule/formPermissions.php') ?>
          <!--End Form-->
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
  ...
  <!--JS Controller-->
  <script src="../controllers/roleModule/roleModule.js"></script>
</body>
