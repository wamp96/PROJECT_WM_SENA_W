...
<body>
    ...
    <div class="container-fluid">
        ...
        <?php require_once('../app/Views/navSlider/navSlider.php') ?>
            <div class="col">
                ...
                <button type="button" class="btn btn-primary btn-actions" title="Button new Request Status" onclick="add()" style="font-size: 0.5em;"><i class="bi bi-plus-circle-fill"></i></button>
                <!--Container Table-->
                <?php require_once('../app/Views/requestStatus/table.php');?>    
                <!--End Container Table-->
            </div>    
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php require_once('../app/Views/requestStatus/form.php')?>
                </div>
    ...
    <!--JS Controller-->
    <script src="../controllers/requestStatus/requestStatus.js"></script>
</body>
</html>